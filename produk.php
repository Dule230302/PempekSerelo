    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            while ($produk = $ambil->fetch_assoc()) {
                ...
                // Jika stok habis, tampilkan notifikasi di atas gambar produk
                if ($data_stok['stok'] <= 0) {
                    echo '<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="team-item text-center rounded overflow-hidden">
                                <div style="position: relative;">
                                    <div class="alert alert-danger" role="alert" style="position: absolute; top: 10px; left: 10px; z-index: 999;">
                                        Stok habis!
                                    </div>
                                ...
                                <div class="team-text">
                                    ...
                                    <div class="team-social">
                                        <!-- Tombol pesan tidak ditampilkan karena stok habis -->
                                    </div>
                                </div>
                            </div>
                        </div>';
