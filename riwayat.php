							...
							<tr>
								...
								<td>
									...
									<?php } elseif ($pecah['statusbeli'] == "Belum di Konfirmasi") { ?>
										<a class="btn btn-primary text-white">Menunggu Konfirmasi Admin</a>
										<a class="btn btn-danger" href="komplen.php?id=<?php echo $pecah['idpenjualanreal'] ?>&status=batal">Batalkan pesanan</a>
									...
									<?php } elseif ($pecah['statusbeli'] == "Pengajuan Pengembalian Pesanan Diterima") { ?>
										<a class="btn btn-primary text-white">Pengajuan Pengembalian Pesanan Diterima</a>
									<?php } elseif ($pecah['statusbeli'] == "Pengajuan Pengembalian Pesanan Ditolak") { ?>
										<a class="btn btn-danger text-white">Pengajuan Pengembalian Pesanan Ditolak</a>
									...
									<?php } elseif ($pecah['statusbeli'] == "Barang Telah Sampai ke Pemesan") { ?>
										...
										<a class="btn btn-danger" href="komplen.php?id=<?php echo $pecah['idpenjualanreal'] ?>&status=kembali">Kembalikan pesanan</a>
									...
									<?php } elseif ($pecah['statusbeli'] == "Pesanan Di Batalkan") { ?>
										<a class="btn btn-danger text-white">Pesanan Anda Sudah Di Batalkan</a>
									<?php } elseif ($pecah['statusbeli'] == "Pesanan Di Kembalikan") { ?>
										<a class="btn btn-danger text-white">Anda Mengembalikan Pesanan</a>
									<?php } ?>
									<br>
									<br>
								</td>
